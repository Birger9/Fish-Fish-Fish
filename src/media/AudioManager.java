...
public class AudioManager {
     ...
     * @return Nothing.
     * @exception IOException,UnsupportedAudioFileException,LineUnavailableException
	...
	final int read = audioInputStream.read(audio, 0, size);
	...
	if(clipIndex > num) {
	    ...
	    try {
		Clip clip = (Clip) AudioSystem.getLine(infoList.get(clipIndex));
